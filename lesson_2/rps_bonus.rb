...
def count_player_wins(player, computer)
  if win?(player, computer)
    $player_win_total += 1
  end
end

def count_computer_wins(computer, player)
...
loop do # MAIN LOOP
  ...
  count_player_wins(user_choice, computer_choice)
  count_computer_wins(computer_choice, user_choice)
